module Views.Gallows exposing (drawGallows)

import Data.Tally as Tally exposing (Tally)
import Html exposing (..)
import Svg exposing (..)
import Svg.Attributes exposing (..)
import VirtualDom as VD exposing (attribute)


xWidth : String -> Svg.Attribute msg
xWidth =
    VD.attribute "x-width"


hideComponentClass : Bool -> String
hideComponentClass hide =
    if hide then
        "hide_component"
    else
        ""
...
turns_gt : Int -> Tally -> Bool
turns_gt left model =
    model.turns_left > left


drawGallows : Tally -> Html.Html msg
drawGallows model =
    svg
        [ id "drawing"
        , xWidth "130mm"
        ...
        [ g [ transform "translate(-27.2 -220)" ]
            [ Svg.path
                [ id "rope"
                , class (hideComponentClass (turns_gt 6 model))
                , fill "#a28d5d"
                , stroke "#a28d5d"
                , d "m392 243c0.0695 21.3-1.32 43.1 0.826 63.9 0.816 14.4-9.87 35.9-13.3 21.9-0.538-15.6 1.04-31.7-0.836-46.9-1.52-22.5 6.28-32.3 13.3-38.9z"
                ]
                []
            , Svg.path
                [ id "brace"
                , fill "#c27207"
                , stroke "#c27207"
                , d "m264 261c-8.46 10.1-15 23.2-26.4 28.4-4.63 8.07-10.4 14.4-15.8 21.4-3.39 1.66-7.4 13.8-10.7 10.1-2.03 7.56-13.3 13.4-16.3 24.1-6.12 5.6-9.68 17.5-24.6-6.21 8.21-9.9 16.4-20.6 26.2-27.3 3.13-13.5 13.3-16.4 18.2-27.4 9.05-4.29 15-16.7 23-24.6 7.56-7.78 8.4-25.1 26.4 1.5z"
                ]
                []
            , Svg.path
                [ id "topbar"
                , Svg.Attributes.style "fill: #c27207; stroke: #c27207;"
            ...
            , Svg.path
                [ id "ground"
                , Svg.Attributes.style "fill: #a28d5d; stroke: #a28d5d"
            ...
            , Svg.path
                [ id "arm1"
                , class (hideComponentClass (turns_gt 0 model))
                , Svg.Attributes.style "fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            , Svg.path
                [ id "arm2"
                , class (hideComponentClass (turns_gt 1 model))
                , Svg.Attributes.style "fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            , Svg.path
                [ id "leg1"
                , class (hideComponentClass (turns_gt 2 model))
                , Svg.Attributes.style "fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            , Svg.path
                [ id "leg2"
                , class (hideComponentClass (turns_gt 3 model))
                , Svg.Attributes.style "fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            , Svg.path
                [ id "body"
                , class (hideComponentClass (turns_gt 4 model))
                , Svg.Attributes.style "fill: #777; stroke: #777; stroke-width: 3.5;"
            ...
            , Svg.path
                [ id "head"
                , class (hideComponentClass (turns_gt 5 model))
                , Svg.Attributes.style "fill:none; stroke: #777; stroke-width: 3.5;"
